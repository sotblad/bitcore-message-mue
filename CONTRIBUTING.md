# Contributing to Bitcore-Mue

We're working hard to make *muecore* the most powerful JavaScript library for working with MonetaryUnit. Our goal is to have *muecore* be a library that can be used by anyone interested in MonetaryUnit, and to level expertise differences with great design and documentation.
...
These are some global design goals in muecore to which any change should adhere.
...
```sh
git remote add mue git@github.com:sotblad/muecore.git
git pull --rebase mue master
```
...
```
Finally go to [github.com/sotblad/muecore](https://github.com/sotblad/muecore) in your web browser and issue a new pull request.
...
[github.com/sotblad/muecore/issues](https://github.com/sotblad/muecore/issues).
